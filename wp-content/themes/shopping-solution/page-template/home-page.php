...
<main role="main" id="skip_content">
  <section id="homesetup">
    <div class="container">
      <div class="row my-5">
        <div class="col-lg-4 col-md-4 col-sm-4">
          <div id="sidebar" class="home-sidebar"><?php dynamic_sidebar('home'); ?></div>
        </div>
            ...
            <section id="slider" class="m-auto p-0 mw-100">
              ...
              <div id="carouselExampleCaptions" class="carousel slide" data-bs-ride="carousel" data-bs-interval="<?php echo esc_attr(get_theme_mod('ecommerce_solution_slider_speed', 3000)); ?>"> 
                              ...
                              <?php if (get_theme_mod( 'ecommerce_solution_show_slider_button',true) != '' || get_theme_mod( 'ecommerce_solution_display_slider_button',true) != ''){ ?>
                                <?php if( get_theme_mod('ecommerce_solution_slider_button_text','SHOP NOW') != ''){ ?>
                                  <div class="more-btn my-md-4 text-start">
                                    <a href="<?php the_permalink(); ?>" class="p-3"><?php echo esc_html( get_theme_mod('ecommerce_solution_slider_button_text',__('SHOP NOW','shopping-solution'))); ?><span class="screen-reader-text"><?php echo esc_html( get_theme_mod('ecommerce_solution_slider_button_text',__('SHOP NOW','shopping-solution'))); ?></span></a>
                                  </div>
                                <?php } ?>
                              <?php } ?>
                            </div>
                ...
                <a class="carousel-control-prev" data-bs-target="#carouselExampleCaptions" data-bs-slide="prev" role="button">
                  ...
                  <span class="screen-reader-text"><?php esc_html_e( 'Previous','shopping-solution' );?></span>
                </a>
                <a class="carousel-control-next" data-bs-target="#carouselExampleCaptions" data-bs-slide="next" role="button">
                  ...
                  <span class="screen-reader-text"><?php esc_html_e( 'Next','shopping-solution' );?></span>
                </a>
              </div>  
          ...
          <section id="new-collection" class="py-5 px-0"> 
            <div class="container">    
              <?php $ecommerce_solution_collection_page = array();
                $mod = absint( get_theme_mod( 'ecommerce_solution_product_settings','shopping-solution'));
                if ( 'page-none-selected' != $mod ) {
